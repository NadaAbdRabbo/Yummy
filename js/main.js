...
function closeSideNav(){
    ...
    $(".side-nav-menu").animate({left:-boxWidth},500);  //i can not put the number static that's why i used boxWidth    
    $(".open-close-icon").addClass("fa-align-justify");
    $(".open-close-icon").removeClass("fa-x");
    $(".links li").animate({top:300},500) // top only works with position 
}
closeSideNav()

//console.log($(".side-nav-menu").css("left")); //css takes the propirty , vaule of propirty
//    console.log($(".side-nav-menu .nav-tab").outerWidth());  To know the outerwidth so i can hide the sidenav
...
function displayMeals(arr){
    ...
    for (i = 0 ; i < arr.length ; i ++){
        cartona += `
        <div class="col-md-3">
                <div onClick="getMealDetalis('${arr[i].idMeal}')" class="meal position-relative overflow-hidden rounded-2 cursor">
...
function displayCategories(arr){
    ...
    for (i = 0 ; i < arr.length ; i ++){
        cartona += `
        <div class="col-md-3">
                <div class="meal position-relative overflow-hidden rounded-2 cursor" onClick="getCategoriesMeals('${arr[i].strCategory}')">
...
function displayArea(arr){
    ...
    for (i = 0 ; i < arr.length ; i ++){
        cartona += `
        <div class="col-md-3">
                <div class="rounded-2 text-center cursor" onClick = "getAreaMeals('${arr[i].strArea}')">        
...
function displayIngredients(arr){
    ...
    for (i = 0 ; i < arr.length ; i ++){
        cartona += `
        <div class="col-md-3">
                <div class="rounded-2 text-center cursor" onClick="getIngredientsMeals('${arr[i].strIngredient}')">        
...
function displayMealDetails(meal){
    ...
    for(let i = 1 ; i <= 20 ; i ++){
        if (meal[`strIngredient${i}`]){
            ingredient += ` <li class="alert alert-danger m-2 p-1">${meal[`strMeasure${i}`]} ${meal[`strIngredient${i}`]} `
    ...
    for (let i = 0 ; i < tags.length ; i ++){
        tagesStr += ` <li class="alert alert-danger m-2 p-1">${tags[i]}</li>`
    }
